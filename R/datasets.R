...
#' to concentrate on the physiognomy of the professor in the
#' picture, to make their ratings independent of age, and to
#' keep 5 in mind as an average. The scores were then
#' normalised.}
#' }
#' @name Beauty
#' @docType data
...
#' consisted of three nitrogen levels (blanket, variable and zero),
#' three irrigation levels (low, medium and high) and three blocks, each
#' being a distinct area. Irrigation treatments were randomly assigned
#' within each block as whole plots. Nitrogen treatments were randomly
#' assigned within each whole block as split plots. Note that the
#' sampling times are $t$=0, 1.14, 2.29, 3.57 and 4.57 weeks (i.e. every
#' 7 to 8 days).
#' \describe{
...
#' Dummy cell data set
#'
#' Example cell data set. An experiment was conducted involving two cell
#' types (Case and Control) and two treatments (A and B). The data is
